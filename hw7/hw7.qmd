...
Lists the names and tags of unused skills, aka, skills that no currently employeed people posesses. NOTE, I added 9 skills instead of 8, so there are 3 unused skills instead of 2. 
```{python}
sql = f"""
